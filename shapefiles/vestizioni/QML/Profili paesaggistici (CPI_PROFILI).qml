...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="CPI_PRO_TY" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="Bordo"/>
      <category value="02" render="true" symbol="1" label="Crinale"/>
      <category value="03" render="true" symbol="2" label="Orlo di terrazzo fluviale"/>
      <category value="04" render="true" symbol="3" label="Profilo"/>
      <category value="" render="true" symbol="4" label="[da definire]"/>
    </categories>
    <symbols>
        ...
        <layer pass="0" enabled="1" locked="0" class="MarkerLine">
          ...
          <symbol type="marker" clip_to_extent="1" name="@0@0" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleMarker">
              ...
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="0,92,255,0" k="outline_color"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CPI_PROFILI_CPI_PRO_TY_ea9c286a_e186_4fba_95c1_e30a21fb802b" name="Layer"/>
            <Option type="QString" value="D_CPI_PROFILI_CPI_PRO_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CPI_PROFILI_CPI_PRO_TY.dbf|layername=D_CPI_PROFILI_CPI_PRO_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CPI_PRO_DE" name="DESCRIZIONE"/>
    <alias index="2" field="CPI_PRO_TY" name="TIPOLOGIA"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CPI_PRO_DE"/>
    <default applyOnUpdate="0" expression="" field="CPI_PRO_TY"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CPI_PRO_DE" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CPI_PRO_TY" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CPI_PRO_DE" desc=""/>
    <constraint exp="" field="CPI_PRO_TY" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="CPI_PRO_DE"/>
      <column hidden="0" type="field" width="-1" name="CPI_PRO_TY"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CPI_PRO_DE"/>
    <field editable="1" name="CPI_PRO_TY"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CPI_PRO_DE"/>
    <field labelOnTop="0" name="CPI_PRO_TY"/>
  </labelOnTop>
  <widgets/>
