...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <aliases>
    ...
    <alias index="1" field="P_USICIV_D" name="DESCERIZIONE"/>
    <alias index="2" field="P_USICIV_C" name="RIFERIMENTO CATASTALE"/>
    <alias index="3" field="P_USICIV_P" name="PROVVEDIMENTO"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="P_USICIV_D"/>
    <default applyOnUpdate="0" expression="" field="P_USICIV_C"/>
    <default applyOnUpdate="0" expression="" field="P_USICIV_P"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_USICIV_D" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_USICIV_C" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_USICIV_P" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="P_USICIV_D" desc=""/>
    <constraint exp="" field="P_USICIV_C" desc=""/>
    <constraint exp="" field="P_USICIV_P" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="P_USICIV_D"/>
      <column hidden="0" type="field" width="-1" name="P_USICIV_C"/>
      <column hidden="0" type="field" width="-1" name="P_USICIV_P"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="P_USICIV_C"/>
    <field editable="1" name="P_USICIV_D"/>
    <field editable="1" name="P_USICIV_P"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="P_USICIV_C"/>
    <field labelOnTop="0" name="P_USICIV_D"/>
    <field labelOnTop="0" name="P_USICIV_P"/>
  </labelOnTop>
  <widgets/>
