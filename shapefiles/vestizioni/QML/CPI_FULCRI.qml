...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="CPI_FULCRI" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="fulcri del costruito"/>
      <category value="02" render="true" symbol="1" label="fulcri naturali"/>
    </categories>
    <symbols>
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" name="@0@0" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleLine">
              ...
              <prop v="156,23,14,255" k="line_color"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" name="@1@0" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleLine">
              ...
              <prop v="0" k="draw_inside_polygon"/>
              <prop v="bevel" k="joinstyle"/>
              <prop v="141,1,255,255" k="line_color"/>
              <prop v="solid" k="line_style"/>
              <prop v="0.3" k="line_width"/>
              <prop v="MM" k="line_width_unit"/>
              <prop v="0" k="offset"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CPI_FULCRI_CPI_FULCRI_TY_0b9bc287_fae2_46cf_b325_55fb4b0dc691" name="Layer"/>
            <Option type="QString" value="D_CPI_FULCRI_CPI_FULCRI_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CPI_FULCRI_CPI_FULCRI_TY.dbf|layername=D_CPI_FULCRI_CPI_FULCRI_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CPI_FULCRI" name="TIPOLOGIA"/>
    <alias index="2" field="CPI_FULCR1" name="DESCRIZIONE"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CPI_FULCRI"/>
    <default applyOnUpdate="0" expression="" field="CPI_FULCR1"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CPI_FULCRI" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CPI_FULCR1" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CPI_FULCRI" desc=""/>
    <constraint exp="" field="CPI_FULCR1" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="CPI_FULCRI"/>
      <column hidden="0" type="field" width="-1" name="CPI_FULCR1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CPI_FULCR1"/>
    <field editable="1" name="CPI_FULCRI"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CPI_FULCR1"/>
    <field labelOnTop="0" name="CPI_FULCRI"/>
  </labelOnTop>
  <widgets/>
