...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{d912eb8d-ae1c-4a06-9267-bac4783341a1}">
      <rule filter="&quot;CNA_GEONAT&quot; = 01" symbol="0" label="Geosito e singolarità geologica" key="{e9e05b65-845f-4216-8350-1cb0a753fa2c}"/>
      <rule filter="&quot;CNA_GEONAT&quot; = 02" symbol="1" label="Aree umide" key="{d2218151-3243-4fb0-b12a-c04abab6b1d4}"/>
      <rule filter="&quot;CNA_GEONAT&quot; = 03" symbol="2" label="Alberi monumentali" key="{b9feb7f6-5ff2-468a-ad5d-57b4b972853b}"/>
      <rule filter="&quot;CNA_GEONAT&quot; = 04" symbol="3" label="Conoide" key="{e3f42fa6-e38c-4a58-8035-32bfb11c019b}"/>
      <rule filter="&quot;CNA_GEONAT&quot; = 05" symbol="4" label="Morena" key="{1b790353-3d84-47a3-9b83-fd1911ba64f8}"/>
      <rule filter="&quot;CNA_GEONAT&quot; = 06" symbol="5" label="Orlo di terrazzo" key="{114069cb-8d18-4b7d-9e28-bb40bccb14ed}"/>
      <rule filter=" &quot;CNA_GEONA1&quot; = '1'" symbol="6" label="RILEVANTE" key="{1379019e-225d-49e5-8650-12956c357151}"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" clip_to_extent="1" name="4" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" name="@4@0" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleLine">
              ...
              <prop v="0" k="draw_inside_polygon"/>
              <prop v="bevel" k="joinstyle"/>
              <prop v="185,222,255,255" k="line_color"/>
              <prop v="solid" k="line_style"/>
              <prop v="0.3" k="line_width"/>
              <prop v="MM" k="line_width_unit"/>
              <prop v="0" k="offset"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" name="@4@1" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleLine">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="5" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="106,172,216,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,76,251,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.26" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CNA_GEONAT_CNA_GEONAT_TY_007ae7b1_c6fb_4f4c_b906_b8c856a93d96" name="Layer"/>
            <Option type="QString" value="D_CNA_GEONAT_CNA_GEONAT_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CNA_GEONAT_CNA_GEONAT_TY.dbf|layername=D_CNA_GEONAT_CNA_GEONAT_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CNA_GEONAT" name="TIPOLOGIA"/>
    <alias index="2" field="CNA_GEONA1" name="RILEVANTE"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CNA_GEONAT"/>
    <default applyOnUpdate="0" expression="" field="CNA_GEONA1"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CNA_GEONAT" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CNA_GEONA1" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CNA_GEONAT" desc=""/>
    <constraint exp="" field="CNA_GEONA1" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="247" name="CNA_GEONAT"/>
      <column hidden="0" type="field" width="-1" name="CNA_GEONA1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CNA_GEONA1"/>
    <field editable="1" name="CNA_GEONAT"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CNA_GEONA1"/>
    <field labelOnTop="0" name="CNA_GEONAT"/>
  </labelOnTop>
  <widgets/>
