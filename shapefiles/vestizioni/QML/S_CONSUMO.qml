...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{d40d8955-e825-49d3-8a15-b63926e85153}">
      <rule filter=" &quot;S_CONSUMO1&quot;  = '03'" symbol="0" label="Superficie consumata in modo reversibile (Scr)" key="{62919ab2-0ba4-4a69-8f24-41c06d43dd81}"/>
      <rule filter=" &quot;S_CONSUMO1&quot;  = '02'" symbol="1" label="Superficie infrastrutturata (Si)" key="{cdaec8ea-d290-48cb-a802-534f53579941}"/>
      <rule filter=" &quot;S_CONSUMO1&quot;  = '01'" symbol="2" label="Superficie urbanizzata (Su)" key="{8e2ef492-90bf-4e3c-8ab6-fd75fcf749fb}"/>
      <rule filter="&quot;S_CONSUMO&quot; = '01'" symbol="3" label="I classe" key="{880569f2-63ad-4c49-a6b4-3500621205fd}"/>
      <rule filter="&quot;S_CONSUMO&quot; = '02'" symbol="4" label="II classe" key="{5673a5f2-93c3-4a59-b109-6f7ef06c961b}"/>
      <rule filter="&quot;S_CONSUMO&quot; = '03'" symbol="5" label="III classe" key="{43443cda-27c1-46cc-9481-72e6f4c73536}"/>
      <rule filter="ELSE" symbol="6" key="{b56bd42d-c78f-4aa8-89a5-5be1ea829e62}"/>
    </rules>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_S_CONSUMO_CAPUSO_TY_eb5404f8_32d8_427c_9900_fa34e8567efe" name="Layer"/>
            <Option type="QString" value="D_S_CONSUMO_CAPUSO_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_S_CONSUMO_CAPUSO_TY.dbf|layername=D_S_CONSUMO_CAPUSO_TY" name="LayerSource"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="" name="FilterExpression"/>
            <Option type="QString" value="CODE" name="Key"/>
            <Option type="QString" value="D_S_CONSUMO_CONSUMO_SUOLO_6990c145_c2eb_4308_a676_ea525b1e29bb" name="Layer"/>
            <Option type="QString" value="D_S_CONSUMO_CONSUMO_SUOLO" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_S_CONSUMO_CONSUMO_SUOLO.dbf|layername=D_S_CONSUMO_CONSUMO_SUOLO" name="LayerSource"/>
            <Option type="int" value="1" name="NofColumns"/>
            <Option type="bool" value="false" name="OrderByValue"/>
            <Option type="bool" value="false" name="UseCompleter"/>
            <Option type="QString" value="NAME" name="Value"/>
  ...
  <aliases>
    ...
    <alias index="1" field="S_CONSUMO" name="CAPACITA d'USO"/>
    <alias index="2" field="S_CONSUMO1" name="CONSUMO"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="S_CONSUMO"/>
    <default applyOnUpdate="0" expression="" field="S_CONSUMO1"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="S_CONSUMO" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="S_CONSUMO1" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="S_CONSUMO" desc=""/>
    <constraint exp="" field="S_CONSUMO1" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="232" name="S_CONSUMO"/>
      <column hidden="0" type="field" width="239" name="S_CONSUMO1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="S_CONSUMO"/>
    <field editable="1" name="S_CONSUMO1"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="S_CONSUMO"/>
    <field labelOnTop="0" name="S_CONSUMO1"/>
  </labelOnTop>
  <widgets/>
