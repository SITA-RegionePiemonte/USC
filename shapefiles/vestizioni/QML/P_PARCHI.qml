...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="TIPO" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="Parco nazionale"/>
      <category value="02" render="true" symbol="1" label="Parco naturale"/>
      <category value="03" render="true" symbol="2" label="Riserva naturale"/>
      <category value="04" render="true" symbol="3" label="Riserva speciale"/>
      <category value="05" render="true" symbol="4" label="Area contigua"/>
      <category value="" render="true" symbol="5" label="[da definire]"/>
    </categories>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_P_PARCHI_TIPOPARCO_156a2ba1_af6d_4ef1_a394_ffb1db99fb0c" name="Layer"/>
            <Option type="QString" value="D_P_PARCHI_TIPOPARCO" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_P_PARCHI_TIPOPARCO.dbf|layername=D_P_PARCHI_TIPOPARCO" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="P_PARCHI_N" name="NOME"/>
    <alias index="2" field="P_PARCHI_1" name="ENTE DI GESTIONE"/>
    <alias index="3" field="TIPO" name="TIPOLOGIA"/>
    <alias index="4" field="ANNO_DI_IS" name="ANNO DI ISTITUZIONE"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="P_PARCHI_N"/>
    <default applyOnUpdate="0" expression="" field="P_PARCHI_1"/>
    <default applyOnUpdate="0" expression="" field="TIPO"/>
    <default applyOnUpdate="0" expression="" field="ANNO_DI_IS"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_PARCHI_N" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_PARCHI_1" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="TIPO" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="ANNO_DI_IS" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="P_PARCHI_N" desc=""/>
    <constraint exp="" field="P_PARCHI_1" desc=""/>
    <constraint exp="" field="TIPO" desc=""/>
    <constraint exp="" field="ANNO_DI_IS" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="P_PARCHI_N"/>
      <column hidden="0" type="field" width="-1" name="P_PARCHI_1"/>
      <column hidden="0" type="field" width="-1" name="TIPO"/>
      <column hidden="0" type="field" width="-1" name="ANNO_DI_IS"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="ANNO_DI_IS"/>
    <field editable="1" name="CLASSID"/>
    <field editable="1" name="P_PARCHI_1"/>
    <field editable="1" name="P_PARCHI_N"/>
    <field editable="1" name="TIPO"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="ANNO_DI_IS"/>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="P_PARCHI_1"/>
    <field labelOnTop="0" name="P_PARCHI_N"/>
