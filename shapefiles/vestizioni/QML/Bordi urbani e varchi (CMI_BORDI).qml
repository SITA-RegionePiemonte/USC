...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="CMI_BORDI" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="bordo urbano"/>
      <category value="02" render="true" symbol="1" label="varco urbano"/>
    </categories>
    <symbols>
      <symbol type="line" clip_to_extent="1" name="0" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop v="209,22,181,255" k="line_color"/>
      ...
      <symbol type="line" clip_to_extent="1" name="1" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="122,207,224,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.66" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CMI_BORDI_CMI_BORDI_TY_84d928c7_5ca8_44c7_bf1b_296d0bc38e0e" name="Layer"/>
            <Option type="QString" value="D_CMI_BORDI_CMI_BORDI_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CMI_BORDI_CMI_BORDI_TY.dbf|layername=D_CMI_BORDI_CMI_BORDI_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CMI_BORDI" name="TIPOLOGIA"/>
    <alias index="2" field="CMI_BORDI1" name="DESCRIZIONE"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CMI_BORDI"/>
    <default applyOnUpdate="0" expression="" field="CMI_BORDI1"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CMI_BORDI" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CMI_BORDI1" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CMI_BORDI" desc=""/>
    <constraint exp="" field="CMI_BORDI1" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="CMI_BORDI"/>
      <column hidden="0" type="field" width="-1" name="CMI_BORDI1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CMI_BORDI"/>
    <field editable="1" name="CMI_BORDI1"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CMI_BORDI"/>
    <field labelOnTop="0" name="CMI_BORDI1"/>
  </labelOnTop>
  <widgets/>
