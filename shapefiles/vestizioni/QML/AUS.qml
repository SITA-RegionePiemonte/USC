...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="1" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="AUS_TY" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="Area di completamento"/>
      <category value="02" render="true" symbol="1" label="Area di trasformazione / sostituzione e riordino / rigenerazione"/>
      <category value="03" render="true" symbol="2" label="Area di nuovo impianto"/>
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" name="@0@0" force_rhr="0" alpha="1">
            <layer pass="0" enabled="1" locked="0" class="SimpleLine">
              ...
              <prop v="0,155,84,255" k="line_color"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_AUS_TIPOLOGIA_e6916671_b2f1_44a5_b959_b845b732407c" name="Layer"/>
            <Option type="QString" value="D_AUS_TIPOLOGIA" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_AUS_TIPOLOGIA.dbf|layername=D_AUS_TIPOLOGIA" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="AUS_SUP" name=""/>
    <alias index="2" field="AUS_TY" name="TIPOLOGIA"/>
    <alias index="3" field="DESTUSO" name=""/>
    <alias index="4" field="H_DESTUSO_DESTINAZIONI_USO_NI_NAME" name=""/>
    <alias index="5" field="H_DESTUSO_DESTINAZIONI_USO_NI_DEFINITION" name=""/>
    <alias index="6" field="H_DESTUSO_DESTINAZIONI_USO_NI_ALPHACODE" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="1" expression="$AREA" field="AUS_SUP"/>
    <default applyOnUpdate="0" expression="" field="AUS_TY"/>
    <default applyOnUpdate="0" expression="" field="DESTUSO"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="AUS_SUP" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="AUS_TY" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="DESTUSO" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="AUS_SUP" desc=""/>
    <constraint exp="" field="AUS_TY" desc=""/>
    <constraint exp="" field="DESTUSO" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="AUS_SUP"/>
      <column hidden="0" type="field" width="-1" name="AUS_TY"/>
      <column hidden="0" type="field" width="-1" name="DESTUSO"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="0" name="AUS_SUP"/>
    <field editable="1" name="AUS_TY"/>
    <field editable="1" name="CLASSID"/>
    <field editable="1" name="DESTUSO"/>
  ...
  <labelOnTop>
    <field labelOnTop="0" name="AUS_SUP"/>
    <field labelOnTop="0" name="AUS_TY"/>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="DESTUSO"/>
