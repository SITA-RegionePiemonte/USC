...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="U_IDRI_TY" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="Aree di salvaguardia delle captazioni potabili prive di un provvedimento di definizione"/>
      <category value="0101" render="true" symbol="1" label="Aree di salvaguardia delle captazioni potabili prive di un provvedimento di definizione - zona di tutela assoluta (>=10m)"/>
      <category value="0102" render="true" symbol="2" label="Aree di salvaguardia delle captazioni potabili prive di un provvedimento di definizione - zona di rispetto (> = 200 m)"/>
      <category value="02" render="true" symbol="3" label="Aree di salvaguardia delle captazioni potabili provviste di specifico provvedimento di definizione"/>
      <category value="0201" render="true" symbol="4" label="Aree di salvaguardia delle captazioni potabili provviste di specifico provvedimento di definizione - zona di tutela assoluta"/>
      <category value="0202" render="true" symbol="5" label="Aree di salvaguardia delle captazioni potabili provviste di specifico provvedimento di definizione - zona di rispetto ristretta"/>
      <category value="0203" render="true" symbol="6" label="Aree di salvaguardia delle captazioni potabili provviste di specifico provvedimento di definizione - zona di rispetto allargata"/>
      <category value="" render="true" symbol="7" label="[da definire]"/>
    </categories>
    <symbols>
      <symbol type="fill" clip_to_extent="1" name="0" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="235,47,47,255" k="color"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="2" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="134,221,184,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="3" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          ...
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="69,122,255,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.46" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="no" k="style"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="6" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="239,226,137,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="H_U_CAPT_U_CAPT_TY_80494347_6790_496c_9e75_22cac981e347" name="Layer"/>
  ...
  <aliases>
    ...
    <alias index="1" field="U_IDRI_TY" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="U_IDRI_TY"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="U_IDRI_TY" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="U_IDRI_TY" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="U_IDRI_TY"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="U_IDRI_TY"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="U_IDRI_TY"/>
  </labelOnTop>
  <widgets/>
