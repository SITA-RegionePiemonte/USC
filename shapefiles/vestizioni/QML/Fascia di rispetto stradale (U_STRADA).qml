...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="U_STRADA_T" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="fascia di rispetto da rete autostradale"/>
      <category value="02" render="true" symbol="1" label="fascia di rispetto da strada extraurbana principale"/>
      <category value="03" render="true" symbol="2" label="fascia di rispetto da strada extraurbana secondaria"/>
      <category value="04" render="true" symbol="3" label="fascia di rispetto da strada urbana di scorrimento"/>
      <category value="05" render="true" symbol="4" label="fascia di rispetto da strada urbana di quartiere"/>
      <category value="06" render="true" symbol="5" label="fascia di rispetto da strada locale"/>
      <category value="" render="true" symbol="6" label="[da definire]"/>
    </categories>
    <symbols>
      <symbol type="fill" clip_to_extent="1" name="0" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="107,226,210,255" k="color"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="1" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="200,114,161,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_U_STRADA_U_STRADA_TY_7c962cae_6f21_42b6_b454_6ef55a2ee511" name="Layer"/>
            <Option type="QString" value="D_U_STRADA_U_STRADA_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_U_STRADA_U_STRADA_TY.dbf|layername=D_U_STRADA_U_STRADA_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="U_STRADA_T" name="TIPOLOGIA"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="U_STRADA_T"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="U_STRADA_T" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="U_STRADA_T" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="U_STRADA_T"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="U_STRADA_T"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="U_STRADA_T"/>
  </labelOnTop>
  <widgets/>
