...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{c8dfb3dc-cded-465a-99f7-f9a700a553e8}">
      <rule filter="&quot;CNA_SIEPI&quot; = 01" symbol="0" label="siepe" key="{77219f07-21fd-4173-85c0-4f9bc3602af8}"/>
      <rule filter="&quot;CNA_SIEPI&quot; = 02" symbol="1" label="filare" key="{ce09c41e-9648-42da-9a8b-905bde3becab}"/>
    </rules>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CNA_SIEPI_TIPO_SIEPI_ccee65d4_737a_48c4_97e9_97a8c9c6201f" name="Layer"/>
            <Option type="QString" value="D_CNA_SIEPI_TIPO_SIEPI" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CNA_SIEPI_TIPO_SIEPI.dbf|layername=D_CNA_SIEPI_TIPO_SIEPI" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CNA_SIEPI" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CNA_SIEPI"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CNA_SIEPI" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CNA_SIEPI" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="CNA_SIEPI"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CNA_SIEPI"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CNA_SIEPI"/>
  </labelOnTop>
  <widgets/>
