...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{29be01f8-4055-4f2d-97ad-b743d7808ecb}">
      <rule filter="&quot;CNA_GHIACC&quot; = 01" symbol="0" label="Ghiacciaio" key="{c0591939-356d-40d9-a5ff-b307530cf4cb}"/>
      <rule filter="&quot;CNA_GHIACC&quot; = 02" symbol="1" label="Roccia" key="{f6127a37-c481-4f85-b0b6-44a850382ee1}"/>
      <rule filter="&quot;CNA_GHIACC&quot; = 03" symbol="2" label="Macereto" key="{efa7b3f4-24e0-4877-942b-f8e2fd294e39}"/>
      <rule filter="ELSE" symbol="3" label="[da definire]" key="{61038da0-4b7d-4275-9727-8c00f1f6c600}"/>
    </rules>
    <symbols>
      <symbol type="fill" clip_to_extent="1" name="0" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="182,189,229,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="100,120,220,255" k="outline_color"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_CNA_GHIACCIAI_CNA_GHIACCIAI_TY_6b0ca30d_3db8_444c_80b8_0b71337d1e25" name="Layer"/>
            <Option type="QString" value="D_CNA_GHIACCIAI_CNA_GHIACCIAI_TY" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_CNA_GHIACCIAI_CNA_GHIACCIAI_TY.dbf|layername=D_CNA_GHIACCIAI_CNA_GHIACCIAI_TY" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="CNA_GHIACC" name="TIPOLOGIA"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="CNA_GHIACC"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="CNA_GHIACC" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="CNA_GHIACC" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="186" name="CNA_GHIACC"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="CNA_GHIACC"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="CNA_GHIACC"/>
  </labelOnTop>
  <widgets/>
