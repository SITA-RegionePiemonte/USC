...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyAlgorithm="0" minScale="1e+08" simplifyMaxScale="1" version="3.6.0-Noosa">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" attr="P_RETEECO" enableorderby="0">
    <categories>
      <category value="01" render="true" symbol="0" label="Area di valore ecologico"/>
      <category value="02" render="true" symbol="1" label="corridoi ecologici"/>
      <category value="03" render="true" symbol="2" label="Varchi"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="D_P_RETEECO_TIPOSITO_3d30cd11_f515_40a4_94c7_d4d6809934d1" name="Layer"/>
            <Option type="QString" value="D_P_RETEECO_TIPOSITO" name="LayerName"/>
            <Option type="QString" value="ogr" name="LayerProviderName"/>
            <Option type="QString" value="F:/GeoUML/geoUML_urbanistica/shapefiles/domini/D_P_RETEECO_TIPOSITO.dbf|layername=D_P_RETEECO_TIPOSITO" name="LayerSource"/>
  ...
  <aliases>
    ...
    <alias index="1" field="P_RETEECO" name="TIPOLOGIA"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CLASSID"/>
    <default applyOnUpdate="0" expression="" field="P_RETEECO"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="CLASSID" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="P_RETEECO" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="CLASSID" desc=""/>
    <constraint exp="" field="P_RETEECO" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="P_RETEECO"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="P_RETEECO"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="CLASSID"/>
    <field labelOnTop="0" name="P_RETEECO"/>
  </labelOnTop>
  <widgets/>
