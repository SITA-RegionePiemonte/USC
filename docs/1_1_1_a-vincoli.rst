...
| 1**     | 2**     | 3**     | 4**     |                             |
+---------+---------+---------+---------+---------+---------+---------+
|Limitazio|Frana    | FA      | Attivo  |         | *Per i  | Circola |
|ni       |         |         |         |         | codici  | re      |
|e        |(Legenda |         |         |         | relativ | PGR n.  |
...
|geologica| senza   |         |         | re      |         |         |
|all'     | partico |         |         | PGR n.  |         |         |
|utilizzaz| lari    |         |         | 7/LAP/9 |         |         |
|ione     | limitaz |         |         | 6       |         |         |
|urbanisti| ioni    |         |         | e       |         |         |
|ca del   | geomorf |         |         | success |         |         |
|territori| ologich |         |         | iva     |         |         |         |
|o        | e       |         |         | Nota    |         |         |
|         | (classe |         |         | Tecnica |         |         |
|         | I)      |         |         | del     |         |         |
|         |         |         |         | 1999    |         |         |
